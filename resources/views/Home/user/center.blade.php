			...
			<div class="wrap-left">
				<div class="wrap-list">
					<div class="m-user">
						...
						<div class="wallet">
							...
							<p class="m-big squareS">
								<a href="#">
									<i><img src="{{url('home/usercenter/images/shopping.png')}}"/></i>
									<span class="m-title">能购物</span>
								</a>
							</p>
							<p class="m-big squareA">
								<a href="#">
									<i><img src="{{url('home/usercenter/images/safe.png')}}"/></i>
									<span class="m-title">够安全</span>
								</a>
							</p>
							<p class="m-big squareL">
								<a href="#">
									<i><img src="{{url('home/usercenter/images/profit.png')}}"/></i>
					...
					<div class="m-order">
						...
						<ul>
							<li><a href="order.html"><i><img src="{{url('home/usercenter/images/pay.png')}}"/></i><span>待付款</span></a></li>
							<li><a href="order.html"><i><img src="{{url('home/usercenter/images/send.png')}}"/></i><span>待发货<em class="m-num">1</em></span></a></li>
							<li><a href="order.html"><i><img src="{{url('home/usercenter/images/receive.png')}}"/></i><span>待收货</span></a></li>
							<li><a href="order.html"><i><img src="{{url('home/usercenter/images/comment.png')}}"/></i><span>待评价<em class="m-num">3</em></span></a></li>
							<li><a href="change.html"><i><img src="{{url('home/usercenter/images/refund.png')}}"/></i><span>退换货</span></a></li>
						</ul>
						<div class="orderContentBox">
							<div class="orderContent">
								<div class="orderContentpic">
									<div class="imgBox">
										<a href="orderinfo.html"><img src="{{url('home/usercenter/images/youzi.jpg')}}"/></a>
									</div>
								</div>
						...
						<div class="orderContentBox">
							<div class="orderContent">
								<div class="orderContentpic">
									<div class="imgBox">
										<a href="orderinfo.html"><img src="{{url('home/usercenter/images/heart.jpg')}}"/></a>
									</div>
								</div>
								<div class="detailContent">
						...
						<div class="twoTabModel credit">
							...
							<div class="Box">
								...
								<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
									<ul class="am-slides">
										<li><a href="#"><img src="{{url('home/usercenter/images/333.jpg')}}"/></a></li>
										<li><a href="#"><img src="{{url('home/usercenter/images/222.jpg')}}"/></a></li>
										<li><a href="#"><img src="{{url('home/usercenter/images/111.jpg')}}"/></a></li>
										<li><a href="#"><img src="{{url('home/usercenter/images/333.jpg')}}"/></a></li>
										<li><a href="#"><img src="{{url('home/usercenter/images/222.jpg')}}"/></a></li>
										<li><a href="#"><img src="{{url('home/usercenter/images/111.jpg')}}"/></a></li>
									</ul>
				...
				<div class="new-goods">
					...
					<div class="new-goods-info">
						<a class="shop-info" href="#">
							<div class="face-img-panel"><img src="{{url('home/usercenter/images/imgsearch1.jpg')}}"/>
							</div>
				...
				<div class="new-goods">
					...
					<div class="new-goods-info">
						<a class="shop-info" href="#" target="_blank">
							<div >
								<img src="{{url('home/usercenter/images/666.jpg')}}"/>
							</div>
                ...
                <div class="am-tabs-bd">
                    ...
                    <div data-tab-panel-0 class="am-tab-panel am-active">
                		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
							<ul class="am-slides">
                               <li>
                               	  <a><img src="{{url('home/usercenter/images/666.jpg')}}"/><img src="{{url('home/usercenter/images/EZA27501.jpg')}}"/></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img src="{{url('home/usercenter/images/BxJk6.jpg')}}"/></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img src="{{url('home/usercenter/images/Hxcag60.jpg')}}"/></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img src="{{url('home/usercenter/images/youzi.jpg')}}"/></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img src="{{url('home/usercenter/images/EZA27501.jpg')}}"/></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img src="{{url('home/usercenter/images/BxJk6.jpg')}}"/></a>
